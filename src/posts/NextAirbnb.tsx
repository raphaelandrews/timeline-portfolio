        ...
        <Post
            ...
            content={
                <>
                    ...
                    <p className="post__content"><a href="https://airbnb-next-raphaelandrews.vercel.app" target="_blank">Demo</a> and <a href="https://github.com/raphaelandrews/airbnb-next" target="_blank">source</a>.</p>                   
                </>
            }

            image={
                <a href="https://airbnb-next-raphaelandrews.vercel.app" target="_blank">
