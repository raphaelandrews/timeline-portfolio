...
import { InteractiveRating, OrderSummary, ThreeColumnPreviewCard, QRcode, ProfileCardComponent, NftCard, MovieApp, AndrewsOS, EcommerceProductPage, Bookstore, NextTwitter, NextAirbnb } from "@/posts";
