...
export const Logo: React.FC<IconTypes> = (props: IconTypes) => {
    return (
        ...
        >
            ...
            <path d="M644.434 584.434L498.187 545.247L605.247 438.187L644.434 584.434Z" fill="var(--first-color)" />
            <path d="M64.8113 584.434L103.998 438.187L211.058 545.247L64.8113 584.434Z" fill="var(--first-color)" />
        </svg>
